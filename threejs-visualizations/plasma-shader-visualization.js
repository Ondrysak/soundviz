(function(){
  ...
  class PlasmaShaderVisualization extends ThreeJSVisualization {
    initialize(){
      ...
      this.material = new THREE.ShaderMaterial({ uniforms:this.uniforms, fragmentShader:frag, vertexShader:`void main(){ gl_Position = projectionMatrix*modelViewMatrix*vec4(position,1.0);} `});
